...
This blog posts explain the interest of unit testing when developing a Python package. It's **not** meant as an in-depth tutorial about how to do unit tests, but rather an overview of what problem it solves and how is it relevant to Python packaging.
...
Let’s look at how unit tests work using a basic example.
...
> A dedicated blog post will cover GitHub Actions in more detail.
