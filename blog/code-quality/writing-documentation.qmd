...
`mkdocs-material` has a ton of super cool customization options, that you often can configure with just one line in your `mkdocs.yaml` file. It's recommended to browse the [official website](https://squidfunk.github.io/mkdocs-material/) for this purpose.

If you're interested in a pre-made configuration template, check out the [Python package template](../../python-package-template.html).
