...
[![](../../img/diataxis.webp)](https://diataxis.fr/){target="_blank"}

Here we will not go in depth on the Diátaxis framework, because the original website is already very complete. We will focus more on technical tools to build great documentation.
