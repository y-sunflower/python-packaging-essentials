...
::: {.callout-tip}
You can quickly check what are the dependencies of a package with the [Python Dependency Explorer](https://y-sunflower.github.io/python-dependency-explorer/){target="_blank"}
:::
